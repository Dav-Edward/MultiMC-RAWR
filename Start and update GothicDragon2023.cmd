...
:modpack_installer
echo.
echo Installing GothicDragon2023...
IF NOT EXIST "%~dp0.\svn\svn.exe" goto :error_svn_missing
.\svn\svn.exe checkout https://github.com/Dav-Edward/MC-GothicDragon2023.git/trunk .\MultiMC\instances\GothicDragon2023 --non-interactive
...
cd %~dp0
start "" .\MultiMC\MultiMC.exe --launch "GothicDragon2023"
exit
